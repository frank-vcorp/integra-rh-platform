...
export default function Procesos() {
  ...
  const [tipoProducto, setTipoProducto] = useState<"ILA" | "ESE">("ILA");
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="space-y-4">
              <div>
                ...
                <Select value={tipoProducto} onValueChange={(v) => setTipoProducto(v as "ILA" | "ESE")}>
                  <SelectTrigger>
                    <SelectValue />
                  </SelectTrigger>
                  <SelectContent>
                    <SelectItem value="ILA">ILA - Investigación Laboral</SelectItem>
                    <SelectItem value="ESE">ESE - Estudio Socioeconómico</SelectItem>
                  </SelectContent>
                </Select>
