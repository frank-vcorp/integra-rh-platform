...
**ID del Checkpoint:** 2025-10-22_1900
...
*   **CREATE:** `c:\proyectos\integra-rh\Checkpoints\CHK_2025-10-22_1900.md` (Este dossier).
...
1.  **Estrategia de Desbloqueo:** La prioridad para la próxima sesión es **actualizar el SDK de Firebase en el cliente de la versión 8 a la versión 9 (API modular)**. Esta actualización es la acción más prometedora para resolver la incompatibilidad de raíz.
